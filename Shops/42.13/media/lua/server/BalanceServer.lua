...
function BServer.Deposit(player, args)
    ...
    msg = string.format(msg, username, account.coin - args[1], account.specialCoin - args[2], account.coin,
        account.specialCoin)
    BServer.writeLog(msg)
...
function BServer.Transfer(player, args)
    ...
    msg =
    "Transfer: Sender %s oldBalance: Coin: %s SpecialCoin %s newBalance: Coin: %s SpecialCoin %s Recipient: %s oldBalance: Coin: %s SpecialCoin %s newBalance: Coin: %s SpecialCoin %s"
    msg = string.format(msg, username, account.coin + args[1], account.specialCoin + args[2], account.coin,
        account.specialCoin,
        args[3], recipientAccount.coin - args[1], recipientAccount.specialCoin - args[2], recipientAccount.coin,
