...
function IncomeUI:createChildren()
	...
	self.totalCoinLabel = ISLabel:new(x + 85, 280, IncomeUI.SMALL_FONT_HGT, "0", 1, 1, 1, 1, UIFont.Medium, true)
	...
	self.totalSpecialCoinLabel = ISLabel:new(x + 85, 305, IncomeUI.SMALL_FONT_HGT, "0", 1, 1, 1, 1, UIFont.Medium, true)
...
function IncomeUI:new(x, y, _width, _height, player)
	local o = {}
	if x == 0 and y == 0 then
